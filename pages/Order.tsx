        ...
        <div className="bg-white dark:bg-surface-dark p-8 md:p-12 rounded-sm shadow-xl border border-gray-100 dark:border-gray-800 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-wider text-gray-500">{t.fields.garment}</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-wider text-gray-500">{t.fields.date}</label>
