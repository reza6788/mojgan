            ...
            >
                <div className="relative p-2 mb-6">
                    ...
                    <img 
                      ...
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBjtpTdZPnicE-RM-lj4EOV243YJqQTZqzlNB6p1N7OXIhXCiuW_IQR_OlaeXcjmjCOtwXY3JZ3sjOIEv6UDYhWjj8Q30YDAwCtlNwgLUgBWPLpflORzmhFhmpKt6-m7JO-7tXhFa584rW12Dq-hWR0Vt4qb2o3ZHSpXbAxkSCG9r3UaC4UUL132P0RpIjGMHzp4OcjDOErxNRjgc8r9aEgIT1AnL6JDXvFubQrCxhvADr1TxTYV3_h3c_vxUYcUZkS8oF-eCHyJGA"
                    />
                </div>
                ...
                <div className="lg:col-span-3 p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <label className="block text-xs uppercase tracking-wider text-gray-500 mb-2">{t.order.fields.garmentType}</label>
